package com.game_of_cells.gameofcells.condition;

import com.game_of_cells.gameofcells.condition.builder.fixed.ConditionBuilder;
import com.game_of_cells.gameofcells.condition.builder.fixed.NumberBuilder;
import com.game_of_cells.gameofcells.condition.builder.fixed.TextBuilder;
import com.game_of_cells.gameofcells.condition.builder.ValueBuilder;
import com.game_of_cells.gameofcells.condition.builder.comparison.EqualBuilder;
import com.game_of_cells.gameofcells.condition.builder.comparison.LessBuilder;
import com.game_of_cells.gameofcells.condition.builder.comparison.LessOrEqualBuilder;
import com.game_of_cells.gameofcells.condition.builder.comparison.MoreBuilder;
import com.game_of_cells.gameofcells.condition.builder.comparison.MoreOrEqualBuilder;
import com.game_of_cells.gameofcells.condition.builder.comparison.NotEqualsBuilder;
import com.game_of_cells.gameofcells.condition.builder.function.CountNeighboursBuilder;
import com.game_of_cells.gameofcells.condition.builder.function.DiffBuilder;
import com.game_of_cells.gameofcells.condition.builder.function.NotBuilder;
import com.game_of_cells.gameofcells.condition.builder.function.RandomBuilder;
import com.game_of_cells.gameofcells.condition.builder.function.SumBuilder;
import com.game_of_cells.gameofcells.condition.builder.logical.AndBuilder;
import com.game_of_cells.gameofcells.condition.builder.logical.OrBuilder;
import com.game_of_cells.gameofcells.condition.facade.NamedValueBuilderFacade;
import com.game_of_cells.gameofcells.condition.facade.SimpleValueBuilderFacade;
import com.game_of_cells.gameofcells.condition.facade.ValueBuilderFacade;
...
import com.game_of_cells.gameofcells.condition.token.Tokenizer;
